...
<?php
    ...
    $clientPrefix = "61624356-3699-4e48-aa27-41f1652eb928";     // [변경필요] 드림시큐리티에서 배포한 웹관리도구 회원사ID 설정

    /* [변경] 결과 수신 후 전달 URL 설정 (GitHub Pages는 PHP 미지원 → 별도 PHP 서버 사용) */
    $result_return_url = "https://sagilrae.com/mok/mok_std_result.php";
